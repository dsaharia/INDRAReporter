    ...
    return (
      <View style={styles.container}>
        <View style={styles.rows}>
          ...
          >
            <ImageBackground
              source={require("./icons/testing.png")}
              style={styles.image}
            ></ImageBackground>
          ...
          <TouchableOpacity
            onPress={() => {
              this.props.navigation.navigate("FloodImpact", {
                selectReport: this.props.selectReport(),
          ...
          >
            <ImageBackground
              source={require("./icons/flood.png")}
              style={styles.image}
            ></ImageBackground>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              this.props.navigation.navigate("Storm", {
                selectReport: this.props.selectReport(),
              });
            }}
          >
            <ImageBackground
              source={require("./icons/cyclone.png")}
              style={styles.image}
            ></ImageBackground>
          ...
          >
            <ImageBackground
              source={require("./icons/storm.png")}
              style={styles.image}
            ></ImageBackground>
